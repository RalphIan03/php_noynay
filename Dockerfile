...
# # 2) Allow .htaccess overrides (common for Laravel/CI/WordPress)
# RUN sed -i 's/AllowOverride None/AllowOverride All/g' /etc/apache2/apache2.conf

# # 3) (Optional) Remove the ServerName warning
# RUN echo "ServerName localhost" >> /etc/apache2/apache2.conf

# 4) Install PHP extensions commonly needed for MariaDB/MySQL
...
# (Optional but recommended) Ensure correct permissions for Apache user
